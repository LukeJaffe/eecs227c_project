...
The goal of this project is to study gradient descent on the triplet margin loss function, a non-convex objective function used in the metric learning domain.
...
We note that there is a large body of literature focused on optimizing functions of the DC form, including \cite{}, \cite{lipp_variations_2016}, and \cite{khamaru_convergence_nodate}.
