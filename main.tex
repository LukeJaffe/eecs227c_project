...
\begin{aligned}
    \min_{\tilde{A}} \quad & \frac{1}{n} \sum_{i=1}^{n} \log{(1 + \exp{(\tilde{z_i}^\top\tilde{A}^\top\tilde{A}\tilde{z_i} - \tilde{y_i}^\top\tilde{A}^\top\tilde{A}\tilde{y_i} + 2\tilde{x_i}^\top\tilde{A}^\top\tilde{A}(\tilde{z_i} - \tilde{y_i}) + \alpha)})}
\end{aligned}
\end{equation}
...
\begin{equation}
\begin{aligned}
g(\tilde{A}) = \tilde{z_i}^\top\tilde{A}^\top\tilde{A}\tilde{z_i} - \tilde{y_i}^\top\tilde{A}^\top\tilde{A}\tilde{y_i} + 2\tilde{x_i}^\top\tilde{A}^\top\tilde{A}(\tilde{z_i} - \tilde{y_i}) + \alpha
\end{aligned}
\end{equation}
...
\begin{align*}
\nabla{g(\tilde{A})}
&= 2\tilde{A}\tilde{z_i}\tilde{z_i}^\top - 2\tilde{A}\tilde{y_i}\tilde{y_i}^\top + 2\tilde{A}(\tilde{x_i}(\tilde{z_i} - \tilde{y_i})^\top + (\tilde{z_i} - \tilde{y_i})\tilde{x_i}^\top) \\
&= 2\tilde{A}(\tilde{z_i}\tilde{z_i}^\top - \tilde{y_i}\tilde{y_i}^\top + \tilde{x_i}(\tilde{z_i} - \tilde{y_i})^\top + (\tilde{z_i} - \tilde{y_i})\tilde{x_i}^\top)
\end{align*}
...
\begin{equation}
\begin{aligned}
g(w) = (w^{\top}z)^2 - (w^{\top}y)^2 + 2(w^{\top}x)(w^{\top}(z - y))
\end{aligned}
\end{equation}

\begin{equation}
\begin{aligned}
\nabla g(w) = 2(zz^{\top} - yy^{\top} + x(z - y)^{\top} + (z - y)x^{\top})w
\end{aligned}
\end{equation}

\begin{equation}
\begin{aligned}
\nabla^2 g(w) = 2(zz^{\top} - yy^{\top} + x(z - y)^{\top} + (z - y)x^{\top})
\end{aligned}
\end{equation}
...
I'm not sure if this is somehow trivial in another way.
