...
In Figure \ref{fig:triplet_viz}, we show the triplet margin loss as posed in (\ref{eq:full_smooth_margin_f}), with $\alpha=0$ and $\alpha=0.1$. We see that
We note that the randomly generated sample gives $f^*=0$ for both cases.
