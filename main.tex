...
Meaning that $f(w)$ is $M_f$-smooth, with $M_f = \|w\|_2^2 \lambda_{\max} (B)^2 + 2 \lambda_{\max} (B)$.
...
We would like to attempt improvement of this bound using the specific structure of our function.
...
\begin{appendices}
\section{Gradient Descent Experiments}
